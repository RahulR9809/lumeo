...
import 'package:lumeo/features/presentation/page/credentials/main_screen/splash.dart';
...
Future main() async {
  ...
  await themeCubit.loadTheme();
    final appID = int.parse(dotenv.env['APP_ID']!);
  ...
  runApp( AppStart(themeCubit: themeCubit));
}

class AppStart extends StatelessWidget {
  final ThemeCubit themeCubit;
  const AppStart({super.key, required this.themeCubit});
  @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
